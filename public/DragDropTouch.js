...
!(function(t) {
  ...
  var e = (function() {
    ...
    return (
      ...
      (t.prototype.setDragImage = function(t, e, n) {
        var o = i._instance
        ;(o._imgCustom = t), (o._imgOffset = { x: e, y: n, })
      }),
      t
    )
  })()
  ...
  var i = (function() {
    function t() {
      if (((this._lastClick = 0), t._instance)) throw "DragDropTouch instance already created."
      if ("ontouchstart" in document) {
        var e = document,
          i = this._touchstart.bind(this),
          n = this._touchmove.bind(this),
          o = this._touchend.bind(this)
        e.addEventListener("touchstart", i), e.addEventListener("touchmove", n), e.addEventListener("touchend", o), e.addEventListener("touchcancel", o)
      }
    }
    return (
      ...
      (t.prototype._touchstart = function(e) {
        ...
        if (this._shouldHandle(e)) {
          if (Date.now() - this._lastClick < t._DBLCLICK && this._dispatchEvent(e, "dblclick", e.target)) return e.preventDefault(), void this._reset()
          this._reset()
      ...
      (t.prototype._touchmove = function(e) {
        if (this._shouldHandle(e)) {
          ...
          if (this._dispatchEvent(e, "mousemove", i)) return (this._lastTouch = e), void e.preventDefault()
          if (this._dragSource && !this._img)
            this._getDelta(e) > t._THRESHOLD &&
              (this._dispatchEvent(e, "dragstart", this._dragSource), this._createImage(e), this._dispatchEvent(e, "dragenter", i))
          this._img &&
            ((this._lastTouch = e),
            e.preventDefault(),
            i != this._lastTarget &&
              (this._dispatchEvent(this._lastTouch, "dragleave", this._lastTarget), this._dispatchEvent(e, "dragenter", i), (this._lastTarget = i)),
            this._moveImage(e),
      ...
      (t.prototype._touchend = function(t) {
        if (this._shouldHandle(t)) {
          if (this._dispatchEvent(this._lastTouch, "mouseup", t.target)) return void t.preventDefault()
          this._img || ((this._dragSource = null), this._dispatchEvent(this._lastTouch, "click", t.target), (this._lastClick = Date.now())),
            this._destroyImage(),
            this._dragSource &&
              (t.type.indexOf("cancel") < 0 && this._dispatchEvent(this._lastTouch, "drop", this._lastTarget),
      ...
      (t.prototype._getTarget = function(t) {
        for (var e = this._getPoint(t), i = document.elementFromPoint(e.x, e.y); i && "none" == getComputedStyle(i).pointerEvents; ) i = i.parentElement
        return i
      }),
      (t.prototype._createImage = function(e) {
        this._img && this._destroyImage()
        var i = this._imgCustom || this._dragSource
        if (((this._img = i.cloneNode(!0)), this._copyStyle(i, this._img), (this._img.style.top = this._img.style.left = "-9999px"), !this._imgCustom)) {
          var n = i.getBoundingClientRect(),
            o = this._getPoint(e)
          ;(this._imgOffset = { x: o.x - n.left, y: o.y - n.top, }), (this._img.style.opacity = t._OPACITY.toString())
        }
      ...
      (t.prototype._copyStyle = function(e, i) {
        if (
          ...
          var n = e,
            o = i
          ;(o.width = n.width), (o.height = n.height), o.getContext("2d").drawImage(n, 0, 0)
        }
        ...
        for (r = 0; r < e.children.length; r++) this._copyStyle(e.children[r], i.children[r])
      }),
      ...
      (t.prototype._closestDraggable = function(t) {
        for (; t; t = t.parentElement) if (t.hasAttribute("draggable") && t.draggable) return t
        return null
      }),
      (t._instance = new t()),
      (t._THRESHOLD = 5),
